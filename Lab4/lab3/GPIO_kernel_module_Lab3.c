...
static unsigned int gpioLED = 71;       ///< hard coding the LED gpio for this example to P9_23 (GPIO49)
static unsigned int gpioButton = 76;   ///< hard coding the button gpio for this example to P9_27 (GPIO115)
